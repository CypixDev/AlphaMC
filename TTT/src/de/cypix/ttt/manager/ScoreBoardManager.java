...
public class ScoreBoardManager {
    ...
    /*public static void sendScoreBoard(Player p){
        ...
        for(int i = 0;i<13;i++){
            ...
            team.addEntry(get(i));
            team.setPrefix(getSuffix(p, layout).get(i));
    ...
    /*public static void updateScoreBoard(Player p){
        ...
        for(int i = 0;i<13;i++){
            board.getTeam(String.valueOf(i)).setPrefix(getSuffix(p, layout).get(i));
        }
    ...
    private static List<String> getSuffix(Player p, int i){
        if(i == 0){
            ...
            list.add("§e ");
            list.add(TeamManager.sayWhatheis(p));
            list.add("§r ");
            list.add("§e ");
            list.add("§b§l"+Main.getInstance().getPlayers().size());
            list.add("§3 ");
            list.add("§e ");
            list.add("§b§l"+MapManager.currentmap);
            list.add("§b ");
            list.add("§c ");
            list.add("§b§l"+CloudAPI.getInstance().getServerId());
            list.add("§8 ");
            list.add("§7 ");
    ...
    public static void sendScoreBoard(Player p){
        ...
        for(int i = 0;i<13;i++){
            Team team = board.registerNewTeam(String.valueOf(i));
            team.setPrefix(getSuffix(p, 0).get(i));
            team.addEntry(get(i));
            obj.getScore(get(i)).setScore(i);
        }
        ...
        line3.setPrefix(getSuffix(p, 0).get(3));
        ...
        line13.setPrefix(getSuffix(p, 0).get(13));*/
    ...
    public static void updateScoreBoard() {
        /*if (p.getScoreboard() != null) {
            ...
            for(int i = 0;i<13;i++){
                obj.getScore(getSuffix(p ,0).get(i)).setScore(i);
            }
        }*/
        /*for(Scoreboard board : boards.keySet()){
            Player p = boards.get(board);
            for(int i = 0;i<13;i++){
                board.getTeam(String.valueOf(i)).setPrefix(getSuffix(p, 0).get(i));
            }
        }*/
