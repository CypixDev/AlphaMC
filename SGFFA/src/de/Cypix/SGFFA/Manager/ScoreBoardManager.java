...
public class ScoreBoardManager {
    ...
    private static List<String> getAnimation(Player p, int i){
        if(i == 0){
            ...
            list.add("§7Map");
            list.add("§b ");
            list.add("§8➤ §b"+MapManager.forceMap);
            list.add("§7Next Map");
            list.add("§c ");
            list.add("§8➤ §b"+String.valueOf(KillStreakManager.getKillStreak(p)));
            list.add("§7KillStreak");
            list.add("§r ");
            return list;
        }
    ...
    public static void updateScoreBoard() {
        ...
        for(Scoreboard board : boards.keySet()){
            ...
            board.getTeam("line9").setPrefix(getAnimation(p, 0).get(6));
            board.getTeam("line10").setPrefix(getAnimation(p, 0).get(7));
            board.getTeam("line11").setPrefix(getAnimation(p, 0).get(8));
            board.getTeam("line12").setPrefix(getAnimation(p, 0).get(9));
