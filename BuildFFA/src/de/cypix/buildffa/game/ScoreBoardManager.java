...
public class ScoreBoardManager {
    ...
    private static List<String> getSuffix(Player p, int i){
        if(i == 0){
            ...
            list.add("§e ");
            list.add("§4 "+KillStreakManager.get(p));
            list.add("§e ");
            list.add("§3 ");
            list.add("§e "+BuildFFA.getInstance().getGameManager().getCurrentmap().getMapname());
            list.add("§e ");
            list.add("§b ");
            list.add("§c "+AlphaAPI.getInstance().getStatsPlayer(p).getBuildFFAStats().getDeaths());
            list.add("§b ");
            list.add("§7 ");
            list.add("§a "+AlphaAPI.getInstance().getStatsPlayer(p).getBuildFFAStats().getKills());
            list.add("§8 ");
            list.add("§3 ");
            list.add("§r ");
            return list;
